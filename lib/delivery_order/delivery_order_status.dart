...
class DeliveryOrderDetailSuccess extends DeliveryOrderDetailState {}
...
class DeliveryGetCompanyNameSuccess extends DeliveryOrderDetailState {
  final String CompanyName;
  DeliveryGetCompanyNameSuccess(this.CompanyName);
}
