...
class newInventoryReceiptsScreen extends StatefulWidget {
  const newInventoryReceiptsScreen({Key? key}) : super(key: key);

  @override
  State<newInventoryReceiptsScreen> createState() => _newdeliveryorderState();
}

class _newdeliveryorderState extends State<newInventoryReceiptsScreen> {
                    ...
                    : () async {
                        ...
                        try {
                          ...
                          cubit.createAndConfirmStockPicking(
                            ...
                            pickingTypeId: 1, // Change if needed
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          hint: Text('${AppLocalizations.of(context).save} $title'),
          items: items
...
class OrderLine {
  ...
  OrderLine({
    ...
    unitId ??= 1; // 🔥 Default Unit of Measure (UoM) ID if null
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "quantity": quantity,
      "unit_id": unitId ?? 1, // 🔥 Ensure a valid unit_id
