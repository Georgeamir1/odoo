...
class NewInventoryReceiptsScreen extends StatefulWidget {
  ...
  @override
  State<NewInventoryReceiptsScreen> createState() =>
      _NewInventoryReceiptsScreenState();
}

class _NewInventoryReceiptsScreenState
    extends State<NewInventoryReceiptsScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => PartnersCubit()..getsuppliers()),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  try {
                    ...
                    // Build move lines from order items
                    ...
                    final orderData = {
                      ...
                      "picking_type_id": 1, // Incoming shipments type
                      "location_id": 8,
                      "location_dest_id": 5,
